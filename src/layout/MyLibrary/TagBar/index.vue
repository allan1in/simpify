<template>
    <div ref="wrapper" class="top-bar-wrapper" @mouseenter="handleMouseEnter" @mouseleave="handleMouseLeave">
        ...
        <Transition name="fade">
            <button v-show="showArrow && !reachedLeft" class="top-bar-wrapper__arrow top-bar-wrapper__arrow-left"
        ...
        <Transition name="fade">
            <button v-show="showArrow && !reachedRight" class="top-bar-wrapper__arrow top-bar-wrapper__arrow-right"
        ...
        <div ref="topBar" class="top-bar-wrapper__top-bar">
            <template v-for="tag in tags" :key="tag">
                <TagButton class="top-bar-wrapper__top-bar__btn" @handle-click="$emit('handleClickTag', tag)"
                    :text="$t(`top_bar.${tag}`)" :isActive="isActive === tag" />
            </template>
        </div>
    </div>
</template>
